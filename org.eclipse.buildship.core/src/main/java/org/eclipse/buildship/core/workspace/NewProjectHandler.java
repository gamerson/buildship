 ...
 * not yet been imported into Eclipse. The handler can decide whether to import it and can apply
 * postprocessing to the newly created project.
 * 
 * @author Stefan Oehme
 *
 */
public interface NewProjectHandler {
    ...
    public static final NewProjectHandler IMPORT_AND_DO_NOTHING = new NewProjectHandler() {
